...
.replace(
  '<<customize_infos>>', r'Modifiez les informations de cette page dans le fichier {\verb source/infos.py}' if infos.first_name == 'Prénom' else ''
)
}
...
latex_documents = [
  ('index', 'prog-dynamique.tex', infos.title,
   infos.author, 'manual'),
]
